...
public class ImageService : IImageService
{
    ...
    public ImageService(IGenericRepository<GeneralImage, Guid> imageRepository, IUnitOfWork unitOfWork,
        IFileService fileService, ILogger<ImageService> logger)
    {
    ...
    public async Task<ResponseResult> UploadImages(UploadImageViewModel model,
        UserProfileModel? currentUser = null)
    {
